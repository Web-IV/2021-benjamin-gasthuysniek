    ...
    public class WebShopDataInit
    {
        ...
        public async Task InititalizeData()
        {
            ...
            if (_dbContext.Database.EnsureCreated())
            {
                ...
                Product product = new Product("Laptop","Strix rog",300,"Good laptop",1);//  public Product(string productclass, string productname,int unitPrice,string description, int? amount=null):this();
